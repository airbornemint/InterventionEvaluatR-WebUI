...
.onLoad <- function(...) {
    ...
    shiny::addResourcePath("iew", system.file("iew", package="InterventionEvaluatR.Web"))
    shiny::addResourcePath("mdb", system.file("mdb", package="InterventionEvaluatR.Web"))
    shiny::addResourcePath("mdbootstrap", system.file("mdbootstrap", package="InterventionEvaluatR.Web"))
}


#' @export
evaluatr.web.ui = function() {
    md_page(
        id="page",
        useShinyjs(),
        singleton(tags$head(
            tags$link(rel = "stylesheet", type = "text/css", href = "iew/iew.css"),
            tags$script(src = "iew/iew.js")
        )),
        div(
            class="fixed-top",
            id="header",
